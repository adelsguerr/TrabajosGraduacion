...
namespace TrabajosGraduacion.Controllers
{
    public class RegistroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RegistroID,Tipo,Titulo,Autor,Año,Facultad,Carrera")] Registro registro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RegistroID,Tipo,Titulo,Autor,Año,Facultad,Carrera")] Registro registro)
        {
